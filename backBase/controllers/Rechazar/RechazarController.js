...
const RechazarController = {
  async rechazarRegistro( req, res ) {
    try {
      const { ID_ALTERNA, LLAVE, FORMULARIO, CAMPO, DESCRIPCION, ID_BLOQUE_FUNCIONAL } = req.params;
      await RechazarService.rechazarRegistro( ID_ALTERNA, LLAVE, FORMULARIO, CAMPO, DESCRIPCION, ID_BLOQUE_FUNCIONAL );
