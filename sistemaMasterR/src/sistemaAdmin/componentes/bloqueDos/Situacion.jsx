    ...
    <>
      ...
      <div className="row">
        ...
        <div className="col-md-3 form-floating mt-3">
          ...
          <label htmlFor="sexo" style={ { marginLeft: '10px' } }>Número de averiguación previa</label>
        </div>
        ...
        <div className="col-md-3 form-floating mt-3">
          ...
          <label htmlFor="sitkey" style={ { marginLeft: '10px' } }>Consecutivo de situación</label>
        </div>
        ...
        <div className="col-md-3 form-floating mt-3">
          ...
          <label htmlFor="clasifica" style={ { marginLeft: '10px' } }>Clasificación juridica del individuo</label>
        </div>
        ...
        <div className="col-md-3 form-floating mt-3">
          ...
          <label htmlFor="peligro" style={ { marginLeft: '10px' } }>Grado de peligrosidad del individuo</label>
        </div>
      ...
      <div className="row">
        ...
        <div className="col-md-3 form-floating mt-3">
          ...
          <label htmlFor="fecact" style={ { marginLeft: '10px' } }>Fecha de actualización</label>
        </div>
      ...
      <div className="row">
        ...
        <div className="col-md-3 form-floating mt-3">
          ...
          <label htmlFor="delito" style={ { marginLeft: '10px' } }>Delito principal</label>
        </div>
        ...
        <div className="col-md-3 form-floating mt-3">
          ...
          <label htmlFor="consig" style={ { marginLeft: '10px' } }>Número de consignación</label>
        </div>
        ...
        <div className="col-md-3 form-floating mt-3">
          ...
          <label htmlFor="consides" style={ { marginLeft: '10px' } }>Descripción de consignación</label>
        </div>
        ...
        <div className="col-md-3 form-floating mt-3">
          ...
          <label htmlFor="mp" style={ { marginLeft: '10px' } }>Ministerio público que consigna</label>
        </div>
      ...
      <div className="row">
        ...
        <div className="col-md-3 form-floating mt-3">
          ...
          <label htmlFor="fechaavei" style={ { marginLeft: '10px' } }>Fecha de averiguación previa</label>
        </div>
        ...
        <div className="col-md-3 form-floating mt-3">
          ...
          <label htmlFor="sendeter" style={ { marginLeft: '10px' } }>Sentido de la determinación por parte del juez</label>
        </div>
